...
-- Sample projects with correct status values
INSERT INTO public.projects (name, description, project_type, status, budget, start_date, end_date, created_by) 
SELECT 'Downtown Luxury Tower', 'Premium residential development in the heart of downtown', 'development', 'in_progress', 15000000, '2024-01-15', '2025-12-31', (SELECT user_id FROM profiles WHERE role = 'administrator' LIMIT 1)
...
INSERT INTO public.projects (name, description, project_type, status, budget, start_date, end_date, created_by) 
SELECT 'Green Valley Villas', 'Sustainable housing development project', 'development', 'in_progress', 12000000, '2024-02-01', '2025-08-15', (SELECT user_id FROM profiles WHERE role = 'administrator' LIMIT 1)
